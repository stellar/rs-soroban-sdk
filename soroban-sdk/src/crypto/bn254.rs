...
/// # Example Usage:
/// ```rust
/// use soroban_sdk::{Env, bytesn, crypto::bn254::{Bn254, G1Affine, Fr}};
/// let env = Env::default();
/// let bn254 = env.crypto().bn254();
/// // Example G1 point addition
/// let p1 = G1Affine::from_bytes(bytesn!(&env, ));
/// let p2 = G1Affine::from_bytes(bytesn!(&env, ));
