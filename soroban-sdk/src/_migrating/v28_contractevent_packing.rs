//! [`contractevent`] events with a map data format omit void fields when publishing, unless
//! `sparse = false`.
//!
...
//! the fields that hold a value. This is the new default, and `sparse = false` opts an event out of
//! it and back to writing every field.
//!
