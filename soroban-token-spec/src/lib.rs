...
impl Token {
    ...
    pub fn init(env: Env, admin: Address, metadata: TokenMetadata) {
    ...
    pub fn approve(env: Env, from: Account, spender: Address, amount: i128) {
        panic!("calling into interface");
    }
    ...
    pub fn freeze(env: Env, admin: Account, id: Address) {
        panic!("calling into interface");
    }
    ...
    pub fn unfreeze(env: Env, admin: Account, id: Address) {
        panic!("calling into interface");
    }
    ...
    pub fn import(env: Env, id: Account, amount: i64) {
        panic!("calling into interface");
    }

    pub fn export(env: Env, id: Account, amount: i64) {
        panic!("calling into interface");
    }
}
