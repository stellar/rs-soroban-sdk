...
- [ ] Patch (v_._.Z) - No change to the public API: bug fixes that preserve documented behavior; performance improvements; internal refactors and private item changes; documentation, example, test, or CI changes; dependency patch bumps.
