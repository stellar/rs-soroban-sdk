...
test-only:
	cargo hack --feature-powerset --ignore-unknown-features --features testutils --exclude-features docs \
		--group-features hazmat,hazmat-crypto-secp256k1_recover,hazmat-crypto-secp256r1_verify \
		test
