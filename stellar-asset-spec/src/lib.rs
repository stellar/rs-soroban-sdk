...
pub(crate) const XDR_INPUT: &[&[u8]] = &[
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_allowance(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_authorized(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_approve(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_balance(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_burn(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_burn_from(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_clawback(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_decimals(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_mint(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_name(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_set_admin(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_admin(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_set_authorized(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_symbol(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_transfer(),
    &soroban_sdk::token::StellarAssetSpec::spec_xdr_transfer_from(),
