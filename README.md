...
Building a contract for wasm with a build system that does not support spec shaking produces a build
error, because the SDK relies on the build system to shake the contract's spec.
