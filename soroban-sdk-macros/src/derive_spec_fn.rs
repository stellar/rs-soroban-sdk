...
pub fn derive_fn_spec(
    ...
    // collide.
    let spec_view_ident = format_ident!("__SPEC_XDR_VIEW_{}", ident);
    ...
    let exported = if export {
        Some(quote! {
            ...
            pub mod #hidden_mod_ident {
                ...
                pub static #spec_ident: [u8; super::#ty::#spec_view_ident.const_xdr_len()] = super::#ty::#spec_fn_ident();
            }
        })
    } else {
        None
    ...
    Ok(quote! {
        ...
        impl #ty {
            #[allow(non_upper_case_globals)]
            #(#attrs)*
            const #spec_view_ident: #path::xdr::ScSpecEntryView<'static> = #spec_view;

            #[allow(non_snake_case)]
            #(#attrs)*
            pub const fn #spec_fn_ident() -> [u8; #ty::#spec_view_ident.const_xdr_len()] {
                #ty::#spec_view_ident.const_to_xdr()
            }
        }
    })
}
