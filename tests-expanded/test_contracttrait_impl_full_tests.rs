...
impl Contract {
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_test_bytes() -> [u8; Contract::__SPEC_XDR_REF_test_bytes.const_xdr_len()]
    {
...
impl Contract {
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_test_string() -> [u8; Contract::__SPEC_XDR_REF_test_string.const_xdr_len()]
    {
...
impl Contract {
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_test_symbol() -> [u8; Contract::__SPEC_XDR_REF_test_symbol.const_xdr_len()]
    {
...
pub mod __Contract__test_duration__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_TEST_DURATION: [u8; super::Contract::__SPEC_XDR_REF_test_duration
...
pub mod __Contract__test_timepoint__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_TEST_TIMEPOINT: [u8; super::Contract::__SPEC_XDR_REF_test_timepoint
...
pub mod __Contract__test_env_param__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_TEST_ENV_PARAM: [u8; super::Contract::__SPEC_XDR_REF_test_env_param
...
impl Contract {
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_test_struct() -> [u8; Contract::__SPEC_XDR_REF_test_struct.const_xdr_len()]
    {
...
pub mod __Contract__test_enum_unit__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_TEST_ENUM_UNIT: [u8; super::Contract::__SPEC_XDR_REF_test_enum_unit
