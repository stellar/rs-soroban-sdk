...
pub mod __Contract__test_timepoint__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_TEST_TIMEPOINT: [u8; super::Contract::spec_xdr_len_test_timepoint()] =
...
pub mod __Contract__test_env_param__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_TEST_ENV_PARAM: [u8; super::Contract::spec_xdr_len_test_env_param()] =
...
pub mod __Contract__test_enum_unit__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_TEST_ENUM_UNIT: [u8; super::Contract::spec_xdr_len_test_enum_unit()] =
