...
static __SOROBAN_SDK_SPEC_MARKER_NODE_3BC169A0483E8DF1: soroban_sdk::MarkerNode =
    soroban_sdk::MarkerNode {
        marker: *b"SpEcV1;\xc1i\xa0H>\x8d\xf1",
        children: &[
            <&'static Address as soroban_sdk::SpecShakingMarker>::MARKER_NODE,
            <&'static Address as soroban_sdk::SpecShakingMarker>::MARKER_NODE,
            <&'static i128 as soroban_sdk::SpecShakingMarker>::MARKER_NODE,
            <Option<&'static u64> as soroban_sdk::SpecShakingMarker>::MARKER_NODE,
        ],
    };
impl<'a> soroban_sdk::SpecShakingMarker for Transfer<'a> {
    const MARKER_NODE: *const soroban_sdk::MarkerNode =
        &raw const __SOROBAN_SDK_SPEC_MARKER_NODE_3BC169A0483E8DF1;
}
