...
mod __Contract__value__spec {
    ...
    #[allow(dead_code)]
    pub static __SPEC_XDR_FN_VALUE: [u8; super::Contract::spec_xdr_len_value()] =
        super::Contract::spec_xdr_value();
}
impl Contract {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_ENTRY_value: soroban_sdk::xdr::r#const::ScSpecEntry =
        soroban_sdk::xdr::r#const::ScSpecEntry::FunctionV0(
            soroban_sdk::xdr::r#const::ScSpecFunctionV0 {
                ...
                name: soroban_sdk::xdr::r#const::ScSymbol(
                    soroban_sdk::xdr::r#const::StringM::try_from_slice_or_panic(b"value"),
                ),
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_len_value() -> usize {
        const { Contract::__SPEC_XDR_ENTRY_value.const_xdr_len() }
    }
    #[allow(non_snake_case)]
    pub const fn spec_xdr_value() -> [u8; Contract::spec_xdr_len_value()] {
        const { Contract::__SPEC_XDR_ENTRY_value.const_to_xdr() }
    }
}
impl<'a> ContractClient<'a> {
...
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).value` instead")]
pub fn __Contract__value__invoke_raw_slice(
    env: soroban_sdk::Env,
    args: &[soroban_sdk::Val],
) -> soroban_sdk::Val {
    if args.len() != 0usize {
    ...
    #[allow(deprecated)]
    __Contract__value__invoke_raw(env)
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).value` instead")]
...
fn __Contract____cd42404d52ad55ccfa9aca4adc828aa5800ad9d385a0671fbcbf724118320619_ctor() {
    ...
    }
    {
        <Contract as soroban_sdk::testutils::ContractFunctionRegister>::register(
            "value",
            #[allow(deprecated)]
            &__Contract__value__invoke_raw_slice,
        );
    }
}
mod test {
    ...
    pub const test_add: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            ...
            source_file: "tests/workspace_contract/src/lib.rs",
            start_line: 22usize,
            start_col: 8usize,
            end_line: 22usize,
            end_col: 16usize,
