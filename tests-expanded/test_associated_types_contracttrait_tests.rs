...
pub fn __Contract__exec__invoke_raw_slice(
    ...
    #[allow(deprecated)]
    __Contract__exec__invoke_raw(env)
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).exec` instead")]
...
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).exec2` instead")]
pub fn __Contract__exec2__invoke_raw_slice(
    env: soroban_sdk::Env,
    args: &[soroban_sdk::Val],
) -> soroban_sdk::Val {
    if args.len() != 0usize {
    ...
    #[allow(deprecated)]
    __Contract__exec2__invoke_raw(env)
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).exec2` instead")]
...
fn __Contract__TraitWithoutContractTrait__b85cb430838ad2be2940af63cd34aab7c962ea8738ef61b7759fbac5a916bc1c_ctor(
    ...
    }
    {
        <Contract as soroban_sdk::testutils::ContractFunctionRegister>::register(
            "exec2",
            #[allow(deprecated)]
            &__Contract__exec2__invoke_raw_slice,
        );
    }
}
mod test {
    ...
    pub const test_exec: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            ...
            source_file: "tests/associated_type_contracttrait/src/lib.rs",
            start_line: 76usize,
            start_col: 8usize,
            end_line: 76usize,
            end_col: 17usize,
    ...
    fn test_exec() {
        ...
        match (&client.exec(), &String::from_str(&e, "default")) {
            (left_val, right_val) => {
        ...
        match (&client.exec2(), &String::from_str(&e, "default2")) {
            (left_val, right_val) => {
                if !(*left_val == *right_val) {
                    let kind = ::core::panicking::AssertKind::Eq;
                    ::core::panicking::assert_failed(
...
mod test_with_wasm {
    ...
    pub const test_exec: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            name: test::StaticTestName("test_with_wasm::test_exec"),
            ignore: false,
            ignore_message: ::core::option::Option::None,
            source_file: "tests/associated_type_contracttrait/src/lib.rs",
            start_line: 97usize,
...
pub fn main() -> () {
    extern crate test;
    test::test_main_static(&[&test_exec, &test_exec])
}
