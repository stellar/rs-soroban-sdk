...
impl soroban_sdk::SpecShakingMarker for UdtEnum2 {
    ...
    fn spec_shaking_marker() {
        {
            static MARKER: [u8; 14] = soroban_sdk::spec_marker(&UdtEnum2::spec_xdr());
...
impl soroban_sdk::SpecShakingMarker for UdtEnum {
    ...
    fn spec_shaking_marker() {
        ...
        {
            static MARKER: [u8; 14] = soroban_sdk::spec_marker(&UdtEnum::spec_xdr());
            let _ = unsafe { ::core::ptr::read_volatile(MARKER.as_ptr()) };
        }
    }
}
...
impl soroban_sdk::SpecShakingMarker for UdtTuple {
    ...
    fn spec_shaking_marker() {
        ...
        {
            static MARKER: [u8; 14] = soroban_sdk::spec_marker(&UdtTuple::spec_xdr());
            let _ = unsafe { ::core::ptr::read_volatile(MARKER.as_ptr()) };
        }
    }
}
...
impl soroban_sdk::SpecShakingMarker for UdtStruct {
    ...
    fn spec_shaking_marker() {
        ...
        <Vec<i64> as soroban_sdk::SpecShakingMarker>::spec_shaking_marker();
        {
            static MARKER: [u8; 14] = soroban_sdk::spec_marker(&UdtStruct::spec_xdr());
            let _ = unsafe { ::core::ptr::read_volatile(MARKER.as_ptr()) };
        }
    }
}
...
impl soroban_sdk::SpecShakingMarker for UdtRecursive {
    ...
    fn spec_shaking_marker() {
        ...
        {
            static MARKER: [u8; 14] = soroban_sdk::spec_marker(&UdtRecursive::spec_xdr());
            let _ = unsafe { ::core::ptr::read_volatile(MARKER.as_ptr()) };
        }
    }
}
...
impl soroban_sdk::SpecShakingMarker for RecursiveToEnum {
    ...
    fn spec_shaking_marker() {
        ...
        {
            static MARKER: [u8; 14] = soroban_sdk::spec_marker(&RecursiveToEnum::spec_xdr());
            let _ = unsafe { ::core::ptr::read_volatile(MARKER.as_ptr()) };
        }
    }
}
...
impl soroban_sdk::SpecShakingMarker for RecursiveEnum {
    ...
    fn spec_shaking_marker() {
        ...
        {
            static MARKER: [u8; 14] = soroban_sdk::spec_marker(&RecursiveEnum::spec_xdr());
            let _ = unsafe { ::core::ptr::read_volatile(MARKER.as_ptr()) };
        }
    }
}
