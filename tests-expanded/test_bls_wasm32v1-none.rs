...
static __SOROBAN_SDK_SPEC_MARKER_NODE_85570041DC7EB722: soroban_sdk::MarkerNode =
    soroban_sdk::MarkerNode {
        marker: *b"SpEcV1\x85W\0A\xdc~\xb7\"",
        children: &[
            <Bls12381Fp as soroban_sdk::SpecShakingMarker>::MARKER_NODE,
            <Bls12381Fp2 as soroban_sdk::SpecShakingMarker>::MARKER_NODE,
            <Bls12381Fr as soroban_sdk::SpecShakingMarker>::MARKER_NODE,
            <Bls12381G1Affine as soroban_sdk::SpecShakingMarker>::MARKER_NODE,
            <Bls12381G2Affine as soroban_sdk::SpecShakingMarker>::MARKER_NODE,
        ],
    };
impl soroban_sdk::SpecShakingMarker for DummyProof {
    const MARKER_NODE: *const soroban_sdk::MarkerNode =
        &raw const __SOROBAN_SDK_SPEC_MARKER_NODE_85570041DC7EB722;
}
