...
pub mod __AddContract__add__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_ADD: [u8; super::AddContract::__SPEC_XDR_REF_add.const_xdr_len()] =
...
impl AddContract {
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_add() -> [u8; AddContract::__SPEC_XDR_REF_add.const_xdr_len()] {
        AddContract::__SPEC_XDR_REF_add.const_to_xdr()
    }
}
impl<'a> AddContractClient<'a> {
...
#[allow(non_snake_case)]
#[deprecated(note = "use `AddContractClient::new(&env, &contract_id).add` instead")]
pub fn __AddContract__add__invoke_raw_slice(
    env: soroban_sdk::Env,
    args: &[soroban_sdk::Val],
) -> soroban_sdk::Val {
    if args.len() != 2usize {
    ...
    #[allow(deprecated)]
    __AddContract__add__invoke_raw(env, args[0usize], args[1usize])
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(note = "use `AddContractClient::new(&env, &contract_id).add` instead")]
...
fn __AddContract____7e9e5ac30f2216fd0fd6f5faed316f2d5983361a4203c3330cfa46ef65bb4767_ctor() {
    ...
    }
    {
        <AddContract as soroban_sdk::testutils::ContractFunctionRegister>::register(
            "add",
            #[allow(deprecated)]
            &__AddContract__add__invoke_raw_slice,
        );
    }
}
mod test {
