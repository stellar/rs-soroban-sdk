...
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).val` instead")]
pub fn __Contract__val__invoke_raw_slice(
    env: soroban_sdk::Env,
    args: &[soroban_sdk::Val],
) -> soroban_sdk::Val {
    if args.len() != 1usize {
    ...
    #[allow(deprecated)]
    __Contract__val__invoke_raw(env, args[0usize])
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).val` instead")]
...
#[allow(non_snake_case)]
#[allow(unused)]
fn __Contract____97dfc65f74283f60c606bda3f75a6a6bec3fc1e513b8b40797b5ecb86c824ee2_ctor() {
    #[allow(unsafe_code)]
    {
        ...
        static f: extern "C" fn() -> ::ctor::__support::CtorRetType = {
            ...
            extern "C" fn f() -> ::ctor::__support::CtorRetType {
                unsafe {
                    __Contract____97dfc65f74283f60c606bda3f75a6a6bec3fc1e513b8b40797b5ecb86c824ee2_ctor();
                };
    ...
    }
    {
        <Contract as soroban_sdk::testutils::ContractFunctionRegister>::register(
            "val",
            #[allow(deprecated)]
            &__Contract__val__invoke_raw_slice,
        );
    }
}
mod test {
    ...
    mod wasm {
        ...
        impl<'a> Client<'a> {
            pub fn val(&self, v: &soroban_sdk::Val) -> soroban_sdk::Val {
                use core::ops::Not;
                let old_auth_manager = self
                    .env
                    .in_contract()
        ...
        impl Args {
            #[inline(always)]
            #[allow(clippy::unused_unit)]
            pub fn val<'i>(v: &'i soroban_sdk::Val) -> (&'i soroban_sdk::Val,) {
                (v,)
            }
        }
    ...
    extern crate test;
    #[rustc_test_marker = "test::test_native_scalar"]
    #[doc(hidden)]
    pub const test_native_scalar: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            name: test::StaticTestName("test::test_native_scalar"),
            ignore: false,
            ignore_message: ::core::option::Option::None,
            source_file: "tests/val/src/lib.rs",
            start_line: 25usize,
            start_col: 8usize,
            end_line: 25usize,
            end_col: 26usize,
        ...
        testfn: test::StaticTestFn(
            #[coverage(off)]
            || test::assert_test_result(test_native_scalar()),
        ),
    };
    fn test_native_scalar() {
        ...
        let r = client.val(&v);
        match (&u32::try_from_val(&e, &r), &Ok(42u32)) {
            (left_val, right_val) => {
    ...
    extern crate test;
    #[rustc_test_marker = "test::test_native_object"]
    #[doc(hidden)]
    pub const test_native_object: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            name: test::StaticTestName("test::test_native_object"),
            ignore: false,
            ignore_message: ::core::option::Option::None,
            source_file: "tests/val/src/lib.rs",
            start_line: 36usize,
        ...
        testfn: test::StaticTestFn(
            #[coverage(off)]
            || test::assert_test_result(test_native_object()),
        ),
    };
    fn test_native_object() {
        ...
        match (&String::try_from_val(&e, &r), &Ok(s)) {
            (left_val, right_val) => {
                if !(*left_val == *right_val) {
                    let kind = ::core::panicking::AssertKind::Eq;
                    ::core::panicking::assert_failed(
    ...
    extern crate test;
    #[rustc_test_marker = "test::test_wasm_scalar"]
    #[doc(hidden)]
    pub const test_wasm_scalar: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            name: test::StaticTestName("test::test_wasm_scalar"),
            ignore: false,
            ignore_message: ::core::option::Option::None,
            source_file: "tests/val/src/lib.rs",
            start_line: 47usize,
        ...
        testfn: test::StaticTestFn(
            #[coverage(off)]
            || test::assert_test_result(test_wasm_scalar()),
        ),
    };
    fn test_wasm_scalar() {
        let e = Env::default();
    ...
    extern crate test;
    #[rustc_test_marker = "test::test_wasm_object"]
    #[doc(hidden)]
    pub const test_wasm_object: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            name: test::StaticTestName("test::test_wasm_object"),
            ignore: false,
            ignore_message: ::core::option::Option::None,
            source_file: "tests/val/src/lib.rs",
            start_line: 58usize,
        ...
        testfn: test::StaticTestFn(
            #[coverage(off)]
            || test::assert_test_result(test_wasm_object()),
        ),
    };
    fn test_wasm_object() {
        let e = Env::default();
