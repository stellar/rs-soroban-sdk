...
impl soroban_sdk::SpecShakingMarker for UsedNestedVecInner {
    #[doc(hidden)]
    #[inline(always)]
    fn spec_shaking_marker() {
        <u32 as soroban_sdk::SpecShakingMarker>::spec_shaking_marker();
        {
            static MARKER: [u8; 14usize] = *b"SpEcV12\x1f\x80P\xe0\x03X^";
            let _ = unsafe { ::core::ptr::read_volatile(MARKER.as_ptr()) };
        }
    }
}
...
impl soroban_sdk::SpecShakingMarker for UsedNestedVecStruct {
    #[doc(hidden)]
    #[inline(always)]
    fn spec_shaking_marker() {
        <Vec<Vec<UsedNestedVecInner>> as soroban_sdk::SpecShakingMarker>::spec_shaking_marker();
        {
            static MARKER: [u8; 14usize] = *b"SpEcV1\x92\xdd7\xaf+\xb6\x86\xa3";
            let _ = unsafe { ::core::ptr::read_volatile(MARKER.as_ptr()) };
        }
    }
}
