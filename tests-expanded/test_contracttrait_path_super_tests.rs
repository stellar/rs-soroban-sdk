...
impl SuperPathTraitSpec {
    ...
    ) -> [u8; SuperPathTraitSpec::__SPEC_XDR_VIEW_super_path_method.const_xdr_len()] {
        SuperPathTraitSpec::__SPEC_XDR_VIEW_super_path_method.const_to_xdr()
    }
}
pub mod submodule {
    ...
    pub mod __ContractSuperPath__super_path_method__spec {
        ...
        pub static __SPEC_XDR_FN_SUPER_PATH_METHOD: [u8;
            super::ContractSuperPath::__SPEC_XDR_VIEW_super_path_method.const_xdr_len()] =
    ...
    impl ContractSuperPath {
        ...
        pub const fn spec_xdr_super_path_method(
            ...
            ContractSuperPath::__SPEC_XDR_VIEW_super_path_method.const_to_xdr()
        }
    }
    impl<'a> ContractSuperPathClient<'a> {
        pub fn super_path_method(&self) -> u32 {
