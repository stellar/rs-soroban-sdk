...
mod test {
    ...
    pub const test_spec_shaking: test::TestDescAndFn = test::TestDescAndFn {
        ...
        testfn: test::StaticTestFn(
            #[coverage(off)]
            || test::assert_test_result(test_spec_shaking()),
        ),
    };
...
pub fn main() -> () {
    extern crate test;
    test::test_main_static(&[&test_spec_shaking])
}
