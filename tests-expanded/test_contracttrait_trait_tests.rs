...
mod test {
    ...
    #[allow(non_upper_case_globals)]
    pub static __SPEC_GRAPH_FN_CONTRACT_TEST_I32: [u8; 42usize] = soroban_sdk::spec_shaking::encode_graph_record::<
        42usize,
        0usize,
    >(
        0,
    ...
    #[allow(non_upper_case_globals)]
    pub static __SPEC_GRAPH_FN_CONTRACT_TEST_ADDRESS: [u8; 42usize] = soroban_sdk::spec_shaking::encode_graph_record::<
        42usize,
        0usize,
    >(
        0,
    ...
    #[allow(non_upper_case_globals)]
    pub static __SPEC_GRAPH_FN_CONTRACT_TEST_BYTES_N: [u8; 42usize] = soroban_sdk::spec_shaking::encode_graph_record::<
        42usize,
        0usize,
    >(
        0,
    ...
    #[allow(non_upper_case_globals)]
    pub static __SPEC_GRAPH_FN_CONTRACT_TEST_U256: [u8; 42usize] = soroban_sdk::spec_shaking::encode_graph_record::<
        42usize,
        0usize,
    >(
        0,
    ...
    #[allow(non_upper_case_globals)]
    pub static __SPEC_GRAPH_FN_CONTRACT_TEST_ENV_PARAM: [u8; 42usize] = soroban_sdk::spec_shaking::encode_graph_record::<
        42usize,
        0usize,
    >(
        0,
