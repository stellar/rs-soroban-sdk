...
mod feat1 {
    ...
    pub mod __Contract__one__spec {
        ...
        pub static __SPEC_XDR_FN_ONE: [u8; super::Contract::__SPEC_XDR_VIEW_one.const_xdr_len()] =
            super::Contract::spec_xdr_one();
    }
    impl Contract {
        #[allow(non_upper_case_globals)]
        const __SPEC_XDR_VIEW_one: soroban_sdk::xdr::ScSpecEntryView<'static> =
            soroban_sdk::xdr::ScSpecEntryView::FunctionV0(soroban_sdk::xdr::ScSpecFunctionV0View {
                doc: soroban_sdk::xdr::StringMView::new(b""),
                name: soroban_sdk::xdr::ScSymbolView(soroban_sdk::xdr::StringMView::new(b"one")),
        ...
        #[allow(non_snake_case)]
        pub const fn spec_xdr_one() -> [u8; Contract::__SPEC_XDR_VIEW_one.const_xdr_len()] {
            Contract::__SPEC_XDR_VIEW_one.const_to_xdr()
        }
    }
    ...
    #[allow(non_snake_case)]
    #[deprecated(note = "use `ContractClient::new(&env, &contract_id).one` instead")]
    pub fn __Contract__one__invoke_raw_slice(
        env: soroban_sdk::Env,
        ...
        #[allow(deprecated)]
        __Contract__one__invoke_raw(env)
    }
    #[doc(hidden)]
    #[allow(non_snake_case)]
    #[deprecated(note = "use `ContractClient::new(&env, &contract_id).one` instead")]
    ...
    fn __Contract____7692c3ad3540bb803c020b3aee66cd8887123234ea0c6e7143c0add73ff431ed_ctor() {
        ...
        }
        {
            <Contract as soroban_sdk::testutils::ContractFunctionRegister>::register(
                "one",
                #[allow(deprecated)]
                &__Contract__one__invoke_raw_slice,
            );
        }
    }
}
mod feat2 {
    ...
    pub mod __super__Contract__two__spec {
        ...
        #[allow(non_snake_case)]
        #[allow(non_upper_case_globals)]
        pub static __SPEC_XDR_FN_TWO: [u8; super::super::Contract::__SPEC_XDR_VIEW_two
            .const_xdr_len()] = super::super::Contract::spec_xdr_two();
    }
    impl super::Contract {
        #[allow(non_upper_case_globals)]
        const __SPEC_XDR_VIEW_two: soroban_sdk::xdr::ScSpecEntryView<'static> =
            soroban_sdk::xdr::ScSpecEntryView::FunctionV0(soroban_sdk::xdr::ScSpecFunctionV0View {
                doc: soroban_sdk::xdr::StringMView::new(b""),
                name: soroban_sdk::xdr::ScSymbolView(soroban_sdk::xdr::StringMView::new(b"two")),
                inputs: soroban_sdk::xdr::VecMView::new(&[]),
                outputs: soroban_sdk::xdr::VecMView::new(&[
                    soroban_sdk::xdr::ScSpecTypeDefView::U32,
                ]),
        ...
        #[allow(non_snake_case)]
        pub const fn spec_xdr_two() -> [u8; super::Contract::__SPEC_XDR_VIEW_two.const_xdr_len()] {
            super::Contract::__SPEC_XDR_VIEW_two.const_to_xdr()
        }
    }
    impl<'a> ContractClient<'a> {
        pub fn two(&self) -> u32 {
    ...
    #[allow(non_snake_case)]
    #[deprecated(note = "use `ContractClient::new(&env, &contract_id).two` instead")]
    pub fn __super__Contract__two__invoke_raw_slice(
        env: soroban_sdk::Env,
        args: &[soroban_sdk::Val],
    ) -> soroban_sdk::Val {
        if args.len() != 0usize {
        ...
        #[allow(deprecated)]
        __super__Contract__two__invoke_raw(env)
    }
    #[doc(hidden)]
    #[allow(non_snake_case)]
    #[deprecated(note = "use `ContractClient::new(&env, &contract_id).two` instead")]
    ...
    fn __super__Contract____3fc4ccfe745870e2c0d99f71f30ff0656c8dedd41cc1d7d3d376b0dbe685e2f3_ctor()
    {
        ...
        }
        {
            <super::Contract as soroban_sdk::testutils::ContractFunctionRegister>::register(
                "two",
                #[allow(deprecated)]
                &__super__Contract__two__invoke_raw_slice,
            );
        }
    }
}
...
pub mod __Contract__zero__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_ZERO: [u8; super::Contract::__SPEC_XDR_VIEW_zero.const_xdr_len()] =
        super::Contract::spec_xdr_zero();
}
impl Contract {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_VIEW_zero: soroban_sdk::xdr::ScSpecEntryView<'static> =
        soroban_sdk::xdr::ScSpecEntryView::FunctionV0(soroban_sdk::xdr::ScSpecFunctionV0View {
            doc: soroban_sdk::xdr::StringMView::new(b""),
            name: soroban_sdk::xdr::ScSymbolView(soroban_sdk::xdr::StringMView::new(b"zero")),
            inputs: soroban_sdk::xdr::VecMView::new(&[]),
            outputs: soroban_sdk::xdr::VecMView::new(&[soroban_sdk::xdr::ScSpecTypeDefView::U32]),
        });
    #[allow(non_snake_case)]
    pub const fn spec_xdr_zero() -> [u8; Contract::__SPEC_XDR_VIEW_zero.const_xdr_len()] {
        Contract::__SPEC_XDR_VIEW_zero.const_to_xdr()
    }
}
impl<'a> ContractClient<'a> {
...
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).zero` instead")]
pub fn __Contract__zero__invoke_raw_slice(
    env: soroban_sdk::Env,
    args: &[soroban_sdk::Val],
) -> soroban_sdk::Val {
    if args.len() != 0usize {
    ...
    #[allow(deprecated)]
    __Contract__zero__invoke_raw(env)
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).zero` instead")]
...
fn __Contract____f9194e73f9e9459e3450ea10a179cdf77aafa695beecd3b9344a98d111622243_ctor() {
    ...
    }
    {
        <Contract as soroban_sdk::testutils::ContractFunctionRegister>::register(
            "zero",
            #[allow(deprecated)]
            &__Contract__zero__invoke_raw_slice,
        );
    }
}
#[rustc_main]
