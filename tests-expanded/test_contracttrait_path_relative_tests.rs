...
pub mod traits {
    ...
    impl RelativePathTraitSpec {
        ...
        const __SPEC_XDR_VIEW_relative_path_method: soroban_sdk::xdr::ScSpecEntryView<
            'static,
        > = soroban_sdk::xdr::ScSpecEntryView::V2(soroban_sdk::xdr::ScSpecEntryV2View {
            id: soroban_sdk::spec_type_id(
                "test_contracttrait_path_relative::traits::RelativePathTraitSpec::relative_path_method",
            ),
            body: soroban_sdk::xdr::ScSpecEntryV2BodyView::FunctionV0(soroban_sdk::xdr::ScSpecFunctionV0View {
                ...
                name: soroban_sdk::xdr::ScSymbolView(
                    soroban_sdk::xdr::StringMView::new(b"relative_path_method"),
                ),
        ...
        ) -> [u8; RelativePathTraitSpec::__SPEC_XDR_VIEW_relative_path_method.const_xdr_len()]
        {
            RelativePathTraitSpec::__SPEC_XDR_VIEW_relative_path_method.const_to_xdr()
        }
    }
}
...
pub fn __ContractRelativePath__relative_path_method__invoke_raw_slice(
    env: soroban_sdk::Env,
    args: &[soroban_sdk::Val],
) -> soroban_sdk::Val {
    if args.len() != 0usize {
    ...
    #[allow(deprecated)]
    __ContractRelativePath__relative_path_method__invoke_raw(env)
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(
...
pub mod __ContractRelativePath__relative_path_method__spec {
    ...
    pub static __SPEC_XDR_FN_RELATIVE_PATH_METHOD: [u8;
        super::ContractRelativePath::__SPEC_XDR_VIEW_relative_path_method.const_xdr_len()] =
        super::ContractRelativePath::spec_xdr_relative_path_method();
}
impl ContractRelativePath {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_VIEW_relative_path_method: soroban_sdk::xdr::ScSpecEntryView<'static> =
        soroban_sdk::xdr::ScSpecEntryView::V2(soroban_sdk::xdr::ScSpecEntryV2View {
            id: soroban_sdk::spec_type_id(
                "test_contracttrait_path_relative::ContractRelativePath::relative_path_method",
            ),
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_relative_path_method(
    ) -> [u8; ContractRelativePath::__SPEC_XDR_VIEW_relative_path_method.const_xdr_len()] {
        ContractRelativePath::__SPEC_XDR_VIEW_relative_path_method.const_to_xdr()
    }
}
impl<'a> ContractRelativePathClient<'a> {
    pub fn relative_path_method(&self) -> u32 {
...
mod test {
    ...
    pub const test_relative_path: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            ...
            source_file: "tests/contracttrait_path_relative/src/lib.rs",
            start_line: 33usize,
            start_col: 8usize,
            end_line: 33usize,
            end_col: 26usize,
    ...
    fn test_relative_path() {
        ...
        match (&client.relative_path_method(), &400) {
            (left_val, right_val) => {
...
pub fn main() -> () {
    extern crate test;
    test::test_main_static(&[&test_relative_path])
}
