...
pub mod __Contract__run__spec {
    ...
    pub static __SPEC_XDR_FN_RUN: [u8; super::Contract::__SPEC_XDR_REF_run.const_xdr_len()] =
        super::Contract::spec_xdr_run();
}
impl Contract {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_REF_run: soroban_sdk::xdr::ScSpecEntryRef<'static> =
        soroban_sdk::xdr::ScSpecEntryRef::FunctionV0(soroban_sdk::xdr::ScSpecFunctionV0Ref {
            doc: soroban_sdk::xdr::StringMRef::new(b""),
            name: soroban_sdk::xdr::ScSymbolRef(soroban_sdk::xdr::StringMRef::new(b"run")),
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_run() -> [u8; Contract::__SPEC_XDR_REF_run.const_xdr_len()] {
        Contract::__SPEC_XDR_REF_run.const_to_xdr()
    }
}
impl<'a> ContractClient<'a> {
