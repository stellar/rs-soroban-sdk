...
mod test_with_wasm {
    ...
    mod contract {
        ...
        impl CreateContractWithConstructorHostFnContext {
            ...
            ) -> [u8; CreateContractWithConstructorHostFnContext::spec_xdr_len()] {
