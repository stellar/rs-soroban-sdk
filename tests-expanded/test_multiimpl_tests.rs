...
mod __Contract__empty__spec {
    ...
    #[allow(dead_code)]
    static __SPEC_XDR_FN_EMPTY: [u8; super::Contract::spec_xdr_len_empty()] =
        super::Contract::spec_xdr_empty();
}
impl Contract {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_ENTRY_empty: soroban_sdk::xdr::r#const::ScSpecEntry =
        soroban_sdk::xdr::r#const::ScSpecEntry::FunctionV0(
            soroban_sdk::xdr::r#const::ScSpecFunctionV0 {
                ...
                name: soroban_sdk::xdr::r#const::ScSymbol(
                    soroban_sdk::xdr::r#const::StringM::try_from_slice_or_panic(b"empty"),
                ),
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_len_empty() -> usize {
        const { Contract::__SPEC_XDR_ENTRY_empty.const_xdr_len() }
    }
    #[allow(non_snake_case)]
    pub const fn spec_xdr_empty() -> [u8; Contract::spec_xdr_len_empty()] {
        const { Contract::__SPEC_XDR_ENTRY_empty.const_to_xdr() }
    }
}
impl<'a> ContractClient<'a> {
    pub fn empty(&self) -> () {
...
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).empty` instead")]
pub fn __Contract__empty__invoke_raw_slice(
    env: soroban_sdk::Env,
    args: &[soroban_sdk::Val],
) -> soroban_sdk::Val {
    if args.len() != 0usize {
    ...
    #[allow(deprecated)]
    __Contract__empty__invoke_raw(env)
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).empty` instead")]
...
mod __Contract__empty2__spec {
    ...
    #[allow(non_upper_case_globals)]
    #[allow(dead_code)]
    static __SPEC_XDR_FN_EMPTY2: [u8; super::Contract::spec_xdr_len_empty2()] =
        super::Contract::spec_xdr_empty2();
}
impl Contract {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_ENTRY_empty2: soroban_sdk::xdr::r#const::ScSpecEntry =
        soroban_sdk::xdr::r#const::ScSpecEntry::FunctionV0(
            soroban_sdk::xdr::r#const::ScSpecFunctionV0 {
                doc: soroban_sdk::xdr::r#const::StringM::try_from_slice_or_panic(b""),
                name: soroban_sdk::xdr::r#const::ScSymbol(
                    soroban_sdk::xdr::r#const::StringM::try_from_slice_or_panic(b"empty2"),
                ),
                inputs: soroban_sdk::xdr::r#const::VecM::try_from_slice_or_panic(&[]),
                outputs: soroban_sdk::xdr::r#const::VecM::try_from_slice_or_panic(&[]),
            },
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_len_empty2() -> usize {
        const { Contract::__SPEC_XDR_ENTRY_empty2.const_xdr_len() }
    }
    #[allow(non_snake_case)]
    pub const fn spec_xdr_empty2() -> [u8; Contract::spec_xdr_len_empty2()] {
        const { Contract::__SPEC_XDR_ENTRY_empty2.const_to_xdr() }
    }
}
impl<'a> ContractClient<'a> {
    pub fn empty2(&self) -> () {
...
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).empty2` instead")]
pub fn __Contract__empty2__invoke_raw_slice(
    env: soroban_sdk::Env,
    args: &[soroban_sdk::Val],
) -> soroban_sdk::Val {
    if args.len() != 0usize {
    ...
    #[allow(deprecated)]
    __Contract__empty2__invoke_raw(env)
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).empty2` instead")]
...
fn __Contract____a081c9c13231c3c184333e4fde14f4f10e045d30869e1b800f4338ab8a726ca4_ctor() {
    ...
    }
    {
        <Contract as soroban_sdk::testutils::ContractFunctionRegister>::register(
            "empty2",
            #[allow(deprecated)]
            &__Contract__empty2__invoke_raw_slice,
        );
    }
}
trait Trait {
...
mod __Contract__empty3__spec {
    ...
    #[allow(non_upper_case_globals)]
    #[allow(dead_code)]
    static __SPEC_XDR_FN_EMPTY3: [u8; super::Contract::spec_xdr_len_empty3()] =
        super::Contract::spec_xdr_empty3();
}
impl Contract {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_ENTRY_empty3: soroban_sdk::xdr::r#const::ScSpecEntry =
        soroban_sdk::xdr::r#const::ScSpecEntry::FunctionV0(
            soroban_sdk::xdr::r#const::ScSpecFunctionV0 {
                doc: soroban_sdk::xdr::r#const::StringM::try_from_slice_or_panic(b""),
                name: soroban_sdk::xdr::r#const::ScSymbol(
                    soroban_sdk::xdr::r#const::StringM::try_from_slice_or_panic(b"empty3"),
                ),
                inputs: soroban_sdk::xdr::r#const::VecM::try_from_slice_or_panic(&[]),
                outputs: soroban_sdk::xdr::r#const::VecM::try_from_slice_or_panic(&[]),
            },
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_len_empty3() -> usize {
        const { Contract::__SPEC_XDR_ENTRY_empty3.const_xdr_len() }
    }
    #[allow(non_snake_case)]
    pub const fn spec_xdr_empty3() -> [u8; Contract::spec_xdr_len_empty3()] {
        const { Contract::__SPEC_XDR_ENTRY_empty3.const_to_xdr() }
    }
}
impl<'a> ContractClient<'a> {
    pub fn empty3(&self) -> () {
...
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).empty3` instead")]
pub fn __Contract__empty3__invoke_raw_slice(
    env: soroban_sdk::Env,
    args: &[soroban_sdk::Val],
) -> soroban_sdk::Val {
    if args.len() != 0usize {
    ...
    #[allow(deprecated)]
    __Contract__empty3__invoke_raw(env)
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[deprecated(note = "use `ContractClient::new(&env, &contract_id).empty3` instead")]
pub extern "C" fn __Contract__empty3__invoke_raw_extern() -> soroban_sdk::Val {
    #[allow(deprecated)]
    __Contract__empty3__invoke_raw(soroban_sdk::Env::default())
}
#[doc(hidden)]
#[allow(non_snake_case)]
#[allow(unused)]
fn __Contract__Trait__2be3aa1100044a64e8135c570a7b382cebaca742493cf17b77052a7ae50fa889_ctor() {
    ...
    }
    {
        <Contract as soroban_sdk::testutils::ContractFunctionRegister>::register(
            "empty3",
            #[allow(deprecated)]
            &__Contract__empty3__invoke_raw_slice,
        );
    }
}
mod test {
