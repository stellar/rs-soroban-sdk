...
pub mod __Contract__empty__spec {
    ...
    pub static __SPEC_XDR_FN_EMPTY: [u8; super::Contract::__SPEC_XDR_VIEW_empty.const_xdr_len()] =
        super::Contract::spec_xdr_empty();
}
impl Contract {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_VIEW_empty: soroban_sdk::xdr::ScSpecEntryView<'static> =
        soroban_sdk::xdr::ScSpecEntryView::FunctionV0(soroban_sdk::xdr::ScSpecFunctionV0View {
            doc: soroban_sdk::xdr::StringMView::new(b""),
            name: soroban_sdk::xdr::ScSymbolView(soroban_sdk::xdr::StringMView::new(b"empty")),
            inputs: soroban_sdk::xdr::VecMView::new(&[]),
            outputs: soroban_sdk::xdr::VecMView::new(&[]),
        });
    #[allow(non_snake_case)]
    pub const fn spec_xdr_empty() -> [u8; Contract::__SPEC_XDR_VIEW_empty.const_xdr_len()] {
        Contract::__SPEC_XDR_VIEW_empty.const_to_xdr()
    }
}
impl<'a> ContractClient<'a> {
    pub fn empty(&self) -> () {
...
pub mod __Contract__empty2__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_EMPTY2: [u8; super::Contract::__SPEC_XDR_VIEW_empty2.const_xdr_len()] =
        super::Contract::spec_xdr_empty2();
}
impl Contract {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_VIEW_empty2: soroban_sdk::xdr::ScSpecEntryView<'static> =
        soroban_sdk::xdr::ScSpecEntryView::FunctionV0(soroban_sdk::xdr::ScSpecFunctionV0View {
            doc: soroban_sdk::xdr::StringMView::new(b""),
            name: soroban_sdk::xdr::ScSymbolView(soroban_sdk::xdr::StringMView::new(b"empty2")),
            inputs: soroban_sdk::xdr::VecMView::new(&[]),
            outputs: soroban_sdk::xdr::VecMView::new(&[]),
        });
    #[allow(non_snake_case)]
    pub const fn spec_xdr_empty2() -> [u8; Contract::__SPEC_XDR_VIEW_empty2.const_xdr_len()] {
        Contract::__SPEC_XDR_VIEW_empty2.const_to_xdr()
    }
}
impl<'a> ContractClient<'a> {
    pub fn empty2(&self) -> () {
...
pub mod __Contract__empty3__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_EMPTY3: [u8; super::Contract::__SPEC_XDR_VIEW_empty3.const_xdr_len()] =
        super::Contract::spec_xdr_empty3();
}
impl Contract {
    #[allow(non_upper_case_globals)]
    const __SPEC_XDR_VIEW_empty3: soroban_sdk::xdr::ScSpecEntryView<'static> =
        soroban_sdk::xdr::ScSpecEntryView::FunctionV0(soroban_sdk::xdr::ScSpecFunctionV0View {
            doc: soroban_sdk::xdr::StringMView::new(b""),
            name: soroban_sdk::xdr::ScSymbolView(soroban_sdk::xdr::StringMView::new(b"empty3")),
            inputs: soroban_sdk::xdr::VecMView::new(&[]),
            outputs: soroban_sdk::xdr::VecMView::new(&[]),
        });
    #[allow(non_snake_case)]
    pub const fn spec_xdr_empty3() -> [u8; Contract::__SPEC_XDR_VIEW_empty3.const_xdr_len()] {
        Contract::__SPEC_XDR_VIEW_empty3.const_to_xdr()
    }
}
impl<'a> ContractClient<'a> {
    pub fn empty3(&self) -> () {
