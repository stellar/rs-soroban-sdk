...
pub mod traits {
    ...
    impl CratePathTraitSpec {
        ...
        ) -> [u8; CratePathTraitSpec::__SPEC_XDR_VIEW_crate_path_method.const_xdr_len()] {
            CratePathTraitSpec::__SPEC_XDR_VIEW_crate_path_method.const_to_xdr()
        }
    }
}
...
pub mod __ContractCratePath__crate_path_method__spec {
    ...
    pub static __SPEC_XDR_FN_CRATE_PATH_METHOD: [u8;
        super::ContractCratePath::__SPEC_XDR_VIEW_crate_path_method.const_xdr_len()] =
...
impl ContractCratePath {
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_crate_path_method(
    ) -> [u8; ContractCratePath::__SPEC_XDR_VIEW_crate_path_method.const_xdr_len()] {
        ContractCratePath::__SPEC_XDR_VIEW_crate_path_method.const_to_xdr()
    }
}
impl<'a> ContractCratePathClient<'a> {
    pub fn crate_path_method(&self) -> u32 {
