...
pub mod traits {
    ...
    impl CratePathTraitSpec {
        ...
        const __SPEC_XDR_REF_crate_path_method: soroban_sdk::xdr::ScSpecEntryRef<'static> =
        ...
        ) -> [u8; CratePathTraitSpec::__SPEC_XDR_REF_crate_path_method.const_xdr_len()] {
            CratePathTraitSpec::__SPEC_XDR_REF_crate_path_method.const_to_xdr()
        }
    }
}
...
pub mod __ContractCratePath__crate_path_method__spec {
    ...
    #[allow(non_snake_case)]
    #[allow(non_upper_case_globals)]
    pub static __SPEC_XDR_FN_CRATE_PATH_METHOD: [u8;
        super::ContractCratePath::__SPEC_XDR_REF_crate_path_method.const_xdr_len()] =
...
impl ContractCratePath {
    ...
    #[allow(non_snake_case)]
    pub const fn spec_xdr_crate_path_method(
    ) -> [u8; ContractCratePath::__SPEC_XDR_REF_crate_path_method.const_xdr_len()] {
        ContractCratePath::__SPEC_XDR_REF_crate_path_method.const_to_xdr()
    }
}
impl<'a> ContractCratePathClient<'a> {
    pub fn crate_path_method(&self) -> u32 {
...
mod test {
    ...
    pub const test_crate_path: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            ...
            source_file: "tests/contracttrait_path_crate/src/lib.rs",
            start_line: 33usize,
            start_col: 8usize,
            end_line: 33usize,
            end_col: 23usize,
